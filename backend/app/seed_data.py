...
def create_items(db: Session, locations: dict) -> list:
    ...
    tv = models.Item(
        ...
        manufacture_date=date(2022, 2, 1),
    ...
    laptop = models.Item(
        ...
        manufacture_date=date(2022, 12, 15),
    ...
    drill = models.Item(
        ...
        manufacture_date=date(2023, 7, 1),
    ...
    desk = models.Item(
        ...
        manufacturer="Uplift",
        model_number="V2-C",
        manufacture_date=date(2022, 10, 1),
    ...
    bicycle = models.Item(
        ...
        manufacture_date=date(2023, 4, 1),
    ...
    vacuum = models.Item(
        ...
        manufacture_date=date(2023, 1, 15),
    ...
    coffee_maker = models.Item(
        ...
        manufacture_date=date(2023, 8, 1),
